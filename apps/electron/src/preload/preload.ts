...
const api: DesktopAPI = {
  ...
  copyText: (text: string) => ipcRenderer.invoke('desktop:copy-text', text) as Promise<void>,
  saveResponse: (bodyBase64: string, suggestedName: string) => ipcRenderer.invoke('response:save', bodyBase64, suggestedName) as Promise<boolean>,
  ...
  renameHistory: (id: string, name: string) => ipcRenderer.invoke('history:rename', id, name) as Promise<void>,
